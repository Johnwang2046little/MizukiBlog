...
export const siteConfig: SiteConfig = {
	title: "糯米粽",
	subtitle: "糯米粽的超棒博客！",
	siteURL: "https://2046home.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/banner.jpg",

			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/banner.jpg",
			], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Johnwang2046little/",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/547130086",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Mail",
					url: "mailto:johnwang2046@outlook.com",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://delicate-gnome-f6812c.netlify.app/.netlify/functions/twikoo",
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "欢迎来到糯米粽的博客！这是我搭建的一个个人空间！", // 公告内容
